...
int insp=10;
int pause=-1,pressed=0,solving=0;
...
void draw()
{
    ...
    //renderBitmapString(0.6,-0.8,GLUT_BITMAP_TIMES_ROMAN_24,"Abhishek V");
    //renderBitmapString(0.6,-0.7,GLUT_BITMAP_TIMES_ROMAN_24,"Chaithanya B S");
    //renderBitmapString(0.5,-0.6,GLUT_BITMAP_TIMES_ROMAN_24,"Project by:");
    if(pause==1)
